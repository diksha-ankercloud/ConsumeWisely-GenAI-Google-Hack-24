                ...
                <div className="row">
                  ...
                  <div className="col-md-10">
                    <div className="card-body p-0">
                      <h5><strong><h5><strong>Personalised Products</strong></h5></strong></h5>
                  ...
                  <div className="">
                    <div className="card mb-3 p-3 rounded-4 shadow border-0">
                      <div className="row g-0">
                        ...
                        <div className="col-md-8">
                          <div className="card-body py-0">
                            <p className="text-muted mb-0"> Fresh Honey Jar</p>
                            <h5 className="card-title">
                              Honey best nectar you wish to get
                            </h5>
                          </div>
                  ...
                  <div className="">
                    <div className="card mb-3 p-3 rounded-4 shadow border-0">
                      <div className="row g-0">
                        ...
                        <div className="col-md-8">
                          <div className="card-body py-0">
                            <p className="text-muted mb-0">Cookies Delight</p>
                            <h5 className="card-title">
                              Taste the sweetness
                            </h5>
                          </div>
                  ...
                  <div className="">
                    <div className="card mb-3 p-3 rounded-4 shadow border-0">
                      <div className="row g-0">
                        ...
                        <div className="col-md-8">
                          <div className="card-body py-0">
                            <p className="text-muted mb-0"> Organic Dal</p>
                            <h5 className="card-title">
                              Best from Farms
                            </h5>
                          </div>
                  ...
                  <div className="">
                    <div className="card mb-3 p-3 rounded-4 shadow border-0">
                      <div className="row g-0">
                        ...
                        <div className="col-md-8">
                          <div className="card-body py-0">
                            <p className="text-muted mb-0">Sprouted Ragi Choco Malt 250g </p>
                            <h5 className="card-title">
                              | Ragi Malt |
                            </h5>
                          </div>
                  ...
                  <div className="">
                    <div className="card mb-3 p-3 rounded-4 shadow border-0">
                      <div className="row g-0">
                        ...
                        <div className="col-md-8">
                          <div className="card-body py-0">
                            <p className="text-muted mb-0">  Foxtail Millet Vermicelli </p>
                            <h5 className="card-title">
                           Thinai Semiya 160g
                            </h5>
                          </div>
          ...
          <div className="row">
            <div className="col-md-6">
              <div
                ...
                style={{
                  background: 'url("images/ad-image-3.png")',
                  backgroundRepeat: "no-repeat",
                  backgroundPosition: "right bottom",
                }}
              >
            ...
            <div className="col-md-6">
              <div
                ...
                style={{
                  background: 'url("images/ad-image-4.png")',
                  backgroundRepeat: "no-repeat",
                  backgroundPosition: "right bottom",
                }}
              >
              ...
              <div className="products-carousel swiper">
                <div className="swiper-wrapper">
                  ...
                  <div className="product-item ">
                    ...
                    <span className="qty">1 Unit</span>
                    <span className="rating">
                      <svg width={24} height={24} className="text-primary">xa
                        <use xlinkHref="#star-solid" />
                      </svg>{" "}
                      4.5
                    </span>
              ...
              <div className="products-carousel swiper">
                <div className="swiper-wrapper">
                  <div className="product-item ">
                    ...
                    <span className="price">Rs 18.00</span>
                    <div className="d-flex align-items-center justify-content-between">
                      <div className="input-group product-qty">
                        <span className="input-group-btn">
                          <button
